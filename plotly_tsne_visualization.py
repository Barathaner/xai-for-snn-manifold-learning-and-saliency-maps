#!/usr/bin/env python3
"""
Interaktive Plotly t-SNE Visualisierung für SHD Datensatz
"""
...
def setup_data():
    """Lädt und bereitet die SHD Daten vor"""
    ...
    return trainset, trans

def create_plotly_tsne_visualization(trainset, trans, target_label=5, n_samples=2, 
                                   perplexity=30, learning_rate=200, n_components=3):
    """
